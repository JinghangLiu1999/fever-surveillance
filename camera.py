            ...
            while True: 
                ...
                for (point_x, point_y, degree) in temp_reading_position: 
                    ...
                    if degree >= MergeCamera.FEVER_THRESHOLD and degree <= 75:
                        ...
                        cv2.imwrite(file_path, detected_merged_frame) 
                        response = requests.post('http://localhost:5000/api/users', json = { 'temperature': degree, 'image_data':image_data, 'file_name':file_name}) 
